        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        // an ad is loaded.
                        InterstitialAds.this.interstitialAd = interstitialAd;
                        Log.i(TAG, "onAdLoaded");
                        Toast.makeText(InterstitialAds.this, "onAdLoaded()", Toast.LENGTH_SHORT).show();
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        ...
                        Toast.makeText(
                                InterstitialAds.this, "onAdFailedToLoad() with error: " + error, Toast.LENGTH_SHORT)
                                .show();
                    }
                });
    }
